...
public class WslServicesMediator : IWslServicesMediator
{
    ...
    /// </remarks>
    public List<WslDistributionInfo> GetAllRegisteredDistributions()
    {
        var distributions = new List<WslDistributionInfo>();
    ...
    {
        _processCreator.CreateProcessWithWindow(GetFileNameForProcessLaunch(), LaunchDistributionArgs.FormatArgs(distributionName));
    }
