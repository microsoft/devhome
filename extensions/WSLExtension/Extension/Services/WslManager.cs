...
public class WslManager : IWslManager
{
    ...
    private readonly List<WslRegisteredDistribution> _registeredWslDistributions = new();
    ...
    public async Task<List<WslDistributionInfo>> GetAllDistributionsAvailableToInstallAsync()
    {
    ...
    public async Task<WslDistributionInfo?> GetInformationOnRegisteredDistributionAsync(string distributionName)
    {
    ...
    /// </summary>
    private async Task<Dictionary<string, WslDistributionInfo>> GetInformationOnAllRegisteredDistributionsAsync()
    {
        _distributionDefinitionsMap ??= await _definitionHelper.GetDistributionDefinitionsAsync();
