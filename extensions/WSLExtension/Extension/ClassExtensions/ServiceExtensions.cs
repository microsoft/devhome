...
public static class ServiceExtensions
{
    public static IServiceCollection AddWslExtensionServices(this IServiceCollection services)
    {
        ...
        // Factory delegate to create WslRegisteredDistributions
        services.AddSingleton<WslRegisteredDistributionFactory>(
            serviceProvider => wslDistributionInfo => ActivatorUtilities.CreateInstance<WslRegisteredDistribution>(serviceProvider, wslDistributionInfo));
