...
namespace winrt::Microsoft::Windows::DevHome::SDK::implementation
{
    ...
    ComputeSystemThumbnailResult::ComputeSystemThumbnailResult(winrt::hresult const& e, hstring const& diagnosticText) :
        m_thumbnailInBytes(array_view<uint8_t>{}), m_result(ProviderOperationStatus::Failure, e, diagnosticText, diagnosticText)
    {
    }
