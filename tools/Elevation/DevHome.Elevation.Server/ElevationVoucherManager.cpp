...
namespace ABI::DevHome::Elevation
{
    ...
    public:
        ...
        STDMETHODIMP AddVoucherToWillCall(
            /* [in] */ IElevationVoucher* voucher) noexcept
        try
        {
...
namespace ABI::DevHome::Elevation
{
    ...
    public:
        STDMETHODIMP RuntimeClassInitialize(HSTRING voucherName, ElevationLevel requestedElevationLevel, ElevationZone zoneId, uint32_t processId) noexcept try
        {
        ...
        STDMETHODIMP Redeem(_COM_Outptr_ IElevationZone** result) noexcept
        {
            ...
            THROW_HR_IF(E_ACCESSDENIED, m_elevationLevel < ourElevationLevel);
    ...
    public:
            ...
            /* [out, retval] */ IElevationVoucher** result) noexcept
        {
            ...
            THROW_IF_FAILED(voucher->RuntimeClassInitialize(voucherName, requestedElevationLevel, zoneId, processId));
            *result = voucher.Detach();
            return S_OK;
        }
    };
