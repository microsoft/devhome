...
public class DevDrivesListViewModelSelector : DataTemplateSelector
{
    ...
    /// </summary>
    public DataTemplate DevDrivesListViewModelLoadedTemplate { get; set; }
    ...
    /// </summary>
    public DataTemplate DevDrivesListViewModelLoadingErrorTemplate { get; set; }

    /// <summary>
    /// Gets or sets the template when there are no DevDriveCardViewModels available in a DevDrivesListViewModel's list.
    /// </summary>
    public DataTemplate NoDevDriveCardViewModelsAvailableTemplate { get; set; }
