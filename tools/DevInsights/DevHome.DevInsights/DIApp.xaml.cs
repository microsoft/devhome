...
using DevHome.DevInsights.Pages;
...
public partial class App : Application, IApp
{
    ...
    public App()
    {
        ...
        Host = Microsoft.Extensions.Hosting.Host.CreateDefaultBuilder()
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton<INavigationService, DINavigationService>();
                services.AddSingleton<TelemetryReporter>();
                services.AddSingleton<DIAppInfoService>();
                services.AddSingleton<DIInsightsService>();
    ...
    internal static bool IsFeatureEnabled()
    {
        ...
        ApplicationData.Current.LocalSettings.Values.TryGetValue($"ExperimentalFeature_DevInsightsExperiment", out var isEnabledObj);
