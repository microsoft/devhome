...
using DevHome.DevInsights.Contracts.ViewModels;
...
internal sealed class DINavigationService : INavigationService
{
    ...
    public DINavigationService(IPageService pageService)
    {
