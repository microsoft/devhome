...
{
    // public const string DefaultDevDriveCardBodyImagePath = "ms-appx:///DevHome.Common/Environments/Assets/EnvironmentsDefaultWallpaper.png";
    ...
    /*
    public DevDriveState CardState
    {
        get => (DevDriveState)GetValue(CardStateProperty);
