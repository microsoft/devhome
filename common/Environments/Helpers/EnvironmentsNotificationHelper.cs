...
public partial class EnvironmentsNotificationHelper
{
    ...
    private void ShowAddUserToAdminGroupAndEnableHyperVNotification()
    {
        ...
        var featureEnabled = ManagementInfrastructureHelper.IsWindowsFeatureAvailable(WindowsOptionalFeatureNames.HyperVPlatform) == FeatureAvailabilityKind.Enabled;
