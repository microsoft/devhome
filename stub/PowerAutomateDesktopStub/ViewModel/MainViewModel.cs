...
using Microsoft.PowerAutomateDesktop.Stub.Helper;
using Microsoft.PowerAutomateDesktop.Stub.Properties;
using Microsoft.PowerAutomateDesktop.Stub.ViewModel;
using System;
...
namespace Microsoft.PowerAutomateDesktop.Stub
{
	public class MainViewModel : ViewModelBase
	{
		...
		public string AppName { get; } = "Power Automate";
		...
		public string ReadyToInstallText { get; }

		public string ErrorTitleText { get; }
		...
		private void UpdateErrorDetails()
		{
			...
			if (openingBracketPosition == -1 || closingBracketPosition == -1) throw new ArgumentException("missing [ or ]");
