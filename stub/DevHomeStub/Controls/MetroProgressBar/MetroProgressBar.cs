...
namespace Microsoft.DevHome.Stub.Controls
{
    /// <summary>
    ...
    public class MetroProgressBar : ProgressBar
    {
        ...
        private static void ToggleIndeterminate(MetroProgressBar bar, bool oldValue, bool newValue)
        {
            ...
            if (indeterminateState != null && bar.GetTemplateChild("ContainingGrid") is FrameworkElement containingObject)
            {
        ...
        {
            if (!(GetTemplateChild("ContainingGrid") is FrameworkElement templateGrid))
            {
                ApplyTemplate();
        ...
        private void SetEllipseDiameter(double width)
        {
            ...
            SetCurrentValue(EllipseDiameterProperty, diameter);
        }
        ...
        private void SetEllipseOffset(double width)
        {
            ...
            SetCurrentValue(EllipseOffsetProperty, offset);
        }
